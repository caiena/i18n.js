(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@caiena/lodash-ext')) :
	typeof define === 'function' && define.amd ? define(['exports', '@caiena/lodash-ext'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.i18n = {}, global._));
	...
	*/
	...
	function Init(i18n) {
	  ...
	  i18n.init = function init() {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},locales = _ref.locales,_ref$defaultLocale = _ref.defaultLocale,defaultLocale = _ref$defaultLocale === void 0 ? null : _ref$defaultLocale,translations = _ref.translations;
	    ...
	    ___default['default'].merge(i18n.translations, translations);
	  };
	...
	___default['default'].each(contents, function (content, _id) {___default['default'].merge(translations, content);});
	___default['default'].each(namespacedContents, function (content, _id) {___default['default'].merge(translations, content);});
