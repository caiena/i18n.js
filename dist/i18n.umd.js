(function (global, factory) {
  ...
  var getBuiltIn$1 = function (namespace, method) {
    return arguments.length < 2 ? aFunction$1$1(global_1$1[namespace]) : global_1$1[namespace] && global_1$1[namespace][method];
  };
  ...
  var store$1$1 = global_1$1[SHARED$1] || setGlobal$1(SHARED$1, {});
  ...
  var has$1$1 = Object.hasOwn || function hasOwn(it, key) {
  ...
  var f$3$1 = descriptors$1 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
    O = toIndexedObject$1(O);
    P = toPropertyKey$1(P);
    if (ie8DomDefine$1) try {
      return $getOwnPropertyDescriptor$1(O, P);
    } catch (error) { /* empty */ }
    if (has$1$1(O, P)) return createPropertyDescriptor$1(!objectPropertyIsEnumerable$1.f.call(O, P), O[P]);
  };
  ...
  var f$2$1 = descriptors$1 ? $defineProperty$1 : function defineProperty(O, P, Attributes) {
    anObject$1(O);
    P = toPropertyKey$1(P);
  ...
  if (nativeWeakMap$1 || sharedStore$1.state) {
    ...
    set$1 = function (it, metadata) {
      if (has$1$1(it, STATE$1)) throw new TypeError(OBJECT_ALREADY_INITIALIZED$1);
      metadata.facade = it;
  ...
  var toAbsoluteIndex$1 = function (index, length) {
    ...
    return integer < 0 ? max$1$1(integer + length, 0) : min$2(integer, length);
  };
  ...
  */
  ...
  _export$1({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG && !CORRECT_IS_REGEXP_LOGIC }, {
    startsWith: function startsWith(searchString /* , position = 0 */) {
      ...
      var index = toLength$1(min$1$1(arguments.length > 1 ? arguments[1] : undefined, that.length));
  ...
  var STRICT_METHOD$1$1 = arrayMethodIsStrict$1('join', ',');

  // `Array.prototype.join` method
  // https://tc39.es/ecma262/#sec-array.prototype.join
  _export$1({ target: 'Array', proto: true, forced: ES3_STRINGS$1 || !STRICT_METHOD$1$1 }, {
  ...
  // `Array.prototype.reduce` method
  // https://tc39.es/ecma262/#sec-array.prototype.reduce
  _export$1({ target: 'Array', proto: true, forced: !STRICT_METHOD$2 || CHROME_BUG$1 }, {
  ...
  if (!has$1$1(IteratorPrototype$2, ITERATOR$2)) {
  ...
  var i18n$1 = createCommonjsModule(function (module) {
  ...
  */
  ...
  function Init(i18n) {
    ...
    i18n.init = function init() {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},locales = _ref.locales,_ref$defaultLocale = _ref.defaultLocale,defaultLocale = _ref$defaultLocale === void 0 ? null : _ref$defaultLocale,translations = _ref.translations;
      ...
      lodashExt.merge(i18n.translations, translations);
    };

    return i18n;
  }

  var i18n = mixin(i18n$1, [
  Sentence,
  FixLocalize,
  Init]);
